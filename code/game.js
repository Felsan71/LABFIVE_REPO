  ...
  for (var y = 0; y < this.height; y++) {
    ...
    for (var x = 0; x < this.width; x++) {
      ...
      // Because there is a third case (space ' '), use an "else if" instead of "else"
        ...
        fieldType = "lava";
	  // Find the level generation loop in the game.js file. Locate the section where
	  // we check the plans array for each character. Add another 'else if' to that 
	  // loop to check for the character y. If 'y' is found, set the fieldtype in the level to floater
	  else if (ch == "y")
		fieldType = "floater";
